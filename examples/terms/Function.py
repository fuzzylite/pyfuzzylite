...
steer = fl.OutputVariable(
    ...
    lock_previous=False,
    terms=[
        fl.Function("left", lt(x,, 0.333), *, (x, -, 0), /, (0.333, -, 0), +, gt(x,, 0.333), *, (0.666, -, x), /, (0.666, -, 0.333), +, eq(x,, 0.333)),
        fl.Function("right", lt(x,, 0.666), *, (x, -, 0.333), /, (0.666, -, 0.333), +, gt(x,, 0.666), *, (1, -, x), /, (1, -, 0.666), +, eq(x,, 0.666))
    ]
)
