...
engine = fl.Engine(
    name="Rectangle", description="obstacle avoidance for self-driving cars"
)
...
engine.output_variables = [
    fl.OutputVariable(
        ...
        lock_previous=False,
        terms=[
            fl.Rectangle("left", 0.000000000, 0.666000000),
            fl.Rectangle("right", 0.333000000, 1.000000000),
        ],
    )
]
engine.rule_blocks = [
