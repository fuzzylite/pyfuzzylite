...
engine.output_variables = [
    fl.OutputVariable(
        ...
        lock_previous=False,
        terms=[
            fl.SigmoidDifference("left", 0.166500000, 30.030030030, 30.030030030, 0.499500000),
            fl.SigmoidDifference("right", 0.499750000, 29.985007496, 29.985007496, 0.833250000)
        ]
    )
]
engine.rule_blocks = [
