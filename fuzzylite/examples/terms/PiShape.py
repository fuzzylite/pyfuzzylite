...
engine = fl.Engine(
    name="PiShape", description="obstacle avoidance for self-driving cars"
)
...
engine.output_variables = [
    fl.OutputVariable(
        ...
        lock_previous=False,
        terms=[
            fl.PiShape("left", 0.000000000, 0.333000000, 0.333000000, 0.666000000),
            fl.PiShape("right", 0.333000000, 0.666500000, 0.666500000, 1.000000000),
        ],
    )
]
engine.rule_blocks = [
